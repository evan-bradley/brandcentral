<template>
  <li class="user-row" v-bind:class="{ 'is-active': user.id == $route.params.userId }">
    <router-link v-on:click.native="select()" class="item-link user-row-link" :to="{ name: 'profile', params:{ userId: user.id } }">
